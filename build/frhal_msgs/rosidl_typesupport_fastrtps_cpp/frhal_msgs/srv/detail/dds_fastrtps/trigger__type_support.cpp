...
#include "frhal_msgs/srv/detail/trigger__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const frhal_msgs::srv::Trigger_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  frhal_msgs::srv::Trigger_Request & ros_message)
{
  // Member: request
  cdr >> ros_message.request;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = frhal_msgs::srv::Trigger_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const frhal_msgs::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<frhal_msgs::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  return &frhal_msgs::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frhal_msgs, srv, Trigger_Request)() {
  return &frhal_msgs::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_frhal_msgs
cdr_serialize(
  const frhal_msgs::srv::Trigger_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  frhal_msgs::srv::Trigger_Response & ros_message)
{
  // Member: result
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = frhal_msgs::srv::Trigger_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const frhal_msgs::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<frhal_msgs::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &frhal_msgs::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frhal_msgs, srv, Trigger_Response)() {
  return &frhal_msgs::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
{
  return &frhal_msgs::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frhal_msgs, srv, Trigger)() {
  return &frhal_msgs::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
