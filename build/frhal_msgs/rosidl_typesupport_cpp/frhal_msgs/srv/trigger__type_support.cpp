...
static const _Trigger_Request_type_support_symbol_names_t _Trigger_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frhal_msgs, srv, Trigger_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, frhal_msgs, srv, Trigger_Request)),
  }
};
...
get_message_type_support_handle<frhal_msgs::srv::Trigger_Request>()
{
  return &::frhal_msgs::srv::rosidl_typesupport_cpp::Trigger_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, frhal_msgs, srv, Trigger_Request)() {
  return get_message_type_support_handle<frhal_msgs::srv::Trigger_Request>();
}
...
static const _Trigger_Response_type_support_symbol_names_t _Trigger_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frhal_msgs, srv, Trigger_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, frhal_msgs, srv, Trigger_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<frhal_msgs::srv::Trigger_Response>()
{
  return &::frhal_msgs::srv::rosidl_typesupport_cpp::Trigger_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, frhal_msgs, srv, Trigger_Response)() {
  return get_message_type_support_handle<frhal_msgs::srv::Trigger_Response>();
}
...
static const _Trigger_type_support_symbol_names_t _Trigger_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frhal_msgs, srv, Trigger)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, frhal_msgs, srv, Trigger)),
  }
};
...
get_service_type_support_handle<frhal_msgs::srv::Trigger>()
{
  return &::frhal_msgs::srv::rosidl_typesupport_cpp::Trigger_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, frhal_msgs, srv, Trigger)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<frhal_msgs::srv::Trigger>();
}
