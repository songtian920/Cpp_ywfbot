...
moveit_ywf_msg__action__MoveitYwfIntf_Goal__init(moveit_ywf_msg__action__MoveitYwfIntf_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->order)) {
    moveit_ywf_msg__action__MoveitYwfIntf_Goal__fini(msg);
    return false;
  }
  return true;
}
...
moveit_ywf_msg__action__MoveitYwfIntf_Goal__create()
{
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_Goal * msg = (moveit_ywf_msg__action__MoveitYwfIntf_Goal *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Goal));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_Goal__init(msg);
  if (!success) {
...
moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Goal * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_Goal *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_Goal__fini(&data[i - 1]);
      }
...
moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence__init(array, size);
  if (!success) {
...
moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_Goal * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_Goal__copy(
...
moveit_ywf_msg__action__MoveitYwfIntf_Result__init(moveit_ywf_msg__action__MoveitYwfIntf_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->result)) {
    moveit_ywf_msg__action__MoveitYwfIntf_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Result * msg = (moveit_ywf_msg__action__MoveitYwfIntf_Result *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Result));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Result * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_Result *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_Result * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_Feedback__init(moveit_ywf_msg__action__MoveitYwfIntf_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->feedback)) {
    moveit_ywf_msg__action__MoveitYwfIntf_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Feedback * msg = (moveit_ywf_msg__action__MoveitYwfIntf_Feedback *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Feedback));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Feedback * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_Feedback *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_Feedback * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__init(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!moveit_ywf_msg__action__MoveitYwfIntf_Goal__init(&msg->goal)) {
    moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__fini(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request * msg)
{
  ...
  // goal
  moveit_ywf_msg__action__MoveitYwfIntf_Goal__fini(&msg->goal);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!moveit_ywf_msg__action__MoveitYwfIntf_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request * msg = (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__init(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response * msg = (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__init(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request * msg = (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__init(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!moveit_ywf_msg__action__MoveitYwfIntf_Result__init(&msg->result)) {
    moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__fini(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response * msg)
{
  ...
  // status
  // result
  moveit_ywf_msg__action__MoveitYwfIntf_Result__fini(&msg->result);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response * rhs)
{
  ...
  // result
  if (!moveit_ywf_msg__action__MoveitYwfIntf_Result__are_equal(
      &(lhs->result), &(rhs->result)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response * msg = (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__init(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!moveit_ywf_msg__action__MoveitYwfIntf_Feedback__init(&msg->feedback)) {
    moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__fini(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  moveit_ywf_msg__action__MoveitYwfIntf_Feedback__fini(&msg->feedback);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!moveit_ywf_msg__action__MoveitYwfIntf_Feedback__are_equal(
      &(lhs->feedback), &(rhs->feedback)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage * msg = (moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage));
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence__init(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage * data = NULL;

  if (size) {
    data = (moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage *)allocator.zero_allocate(size, sizeof(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence__fini(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence * array = (moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence *)allocator.allocate(sizeof(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence__destroy(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence__are_equal(const moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence * lhs, const moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage * data =
      (moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_ywf_msg__action__MoveitYwfIntf_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
