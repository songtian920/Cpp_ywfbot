...
static const _RobotNonrtState_type_support_symbol_names_t _RobotNonrtState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_msgs, msg, RobotNonrtState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fairino_msgs, msg, RobotNonrtState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fairino_msgs, msg, RobotNonrtState)() {
  return &::fairino_msgs::msg::rosidl_typesupport_c::RobotNonrtState_message_type_support_handle;
}
