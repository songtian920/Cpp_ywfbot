...
public:
    ...
    //TODO::add moveJoint
    int MoveJoint(std::string para);
    int MoveJoint_ywf(std::string para);
    int MovePose(std::string para);
    int MovePose_ywf(std::string para);
    int MoveL_Joint(std::string para);
    int MoveL_Joint_ywf(std::string para);
    int MoveL_Pose(std::string para);
    int MoveL_Pose_ywf(std::string para);
    int Start(std::string para);
    int Pause(std::string para);
    int Resume(std::string para);
